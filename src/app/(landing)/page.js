...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex flex-col mx-auto items-center justify-center">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Share, buy, and open-source UI components created with Shadcn
                  and NextUI.
                </p>
              </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    A customizable multi-step form with validation and progress
                    tracking.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    A collection of responsive and interactive chart components.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="aspect-video rounded-md bg-gray-100 dark:bg-gray-800" />
            ...
            <div className="grid gap-6 items-center">
              <div className="flex aspect-video items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Interactive component demo goes here
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Earn badges, get recognized, and contribute to the growing
                  ecosystem of modern UI components.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
