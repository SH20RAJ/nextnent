...
import { Star, Download, Heart, Search, DollarSign } from "lucide-react";
...
const components = [
  {
    ...
    description:
      "Fully featured data table with sorting, filtering, and pagination.",
  ...
  },
  {
    ...
    description:
      "Customizable multi-step form with validation and progress tracking.",
    image: "/placeholder.svg?height=100&width=200",
    price: 0,
    rating: 4.8,
    downloads: 2500,
...
export default function ExplorePage() {
  ...
  const filteredComponents = components.filter(
    (component) =>
      ...
      (priceFilter === "all" ||
        (priceFilter === "free" && component.price === 0) ||
        (priceFilter === "paid" && component.price > 0)) &&
                            ...
                            <Dialog>
                              ...
                              <DialogContent>
                                <div className="w-full h-96 bg-muted flex items-center justify-center">
                                  <p>
                                    Live preview of {component.title} goes here
                                  </p>
                                </div>
                              </DialogContent>
                            </Dialog>
        ...
        <section className="py-12">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-bold mb-4">
              Sell Your Component on NextNent
            </h2>
            <p className="mb-6">
              Join our community of developers and earn from your creations.
            </p>
            <Button size="lg">
              Start Selling
      ...
      <footer className="bg-muted py-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2024 NextNent. All rights reserved.
          </p>
